...
msg: db "File opened successfully",0x0A     ; opening
len: equ $-msg                              ;
msg1: db "File closed successfully",0x0A    ; closing
len1: equ $-msg1                            ;
msg2: db "Error in opening file",0x0A       ;opening
len2: equ $-msg2                            
...
mov rax,2                                   ; Open the file read-only mode
mov rdi,fname
mov rsi,2
mov rdx,0777
syscall
...
jc next
rw 1,1,msg,len                           ; Print the success message for file opening
jmp next2
next:
rw 1,1,msg2,len2                         ; Print the error message for file opening
...
rw 1,1,msg3,len3                         ; Print the message for spaces

call spaces                                 ; Call the 'spaces' function to count the number of spaces in the buffer

rw 1,1,msg4,len4                         ; Print the message for newlines

call enters                                 ; Call the 'enters' function to count the number of newlines in the buffer

rw 1,1,msg5,len5                         ; Print the message for prompting user to enter a character
rw 0,1,cha,2                             ; Read a character from the user and store it in 'cha'
